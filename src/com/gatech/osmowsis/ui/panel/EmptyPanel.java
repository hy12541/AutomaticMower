...
public class EmptyPanel extends JPanel {
	...
	public EmptyPanel(boolean hasRechargingPad, UIGopher uiGopher, boolean isHighlighted) {
		super();
	...
	private void initialize() {
		...
		labelEmpty.setSize(ImageService.getInstance().getSquareWidth(), ImageService.getInstance().getSquareWidth());
